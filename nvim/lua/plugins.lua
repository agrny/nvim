return require("lazy").setup({
	...
	performance = {
		rtp = {
			disabled_plugins = {
				"2html_plugin", "tohtml", "getscript", "getscriptPlugin", "logipat", "netrw",
				"netrwPlugin", "netrwSettings", "netrwFileHandlers", "matchit",
				"rrhelper", "spellfile_plugin", "vimball", "vimballPlugin", "tutor",
